      ...
      <section className="w-full max-w-md rounded-[1.75rem] border border-slate-200/80 bg-white/85 p-8 text-slate-900 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur-sm">
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-600">
            Sign in to keep your session for one hour.
          </p>
        </div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-3 text-sm text-slate-600 sm:grid-cols-2">
          <Link
            className="inline-flex w-full items-center justify-center rounded-full border border-slate-200 bg-white px-4 py-2 font-medium text-slate-700 transition hover:border-slate-300 hover:bg-slate-50 hover:text-slate-950"
            href="/signup"
          >
            Go to signup
          </Link>
